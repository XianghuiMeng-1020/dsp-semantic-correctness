...
stability~\cite{oppenheim2010dsp,proakis2007dsp,rabiner1975theory}:
...
theory~\cite{kaiser1974window,harris1978windows,rabiner1970freqsamp,parks1972chebyshev,mcclellan1973computer,rabiner1975fir,butterworth1930,constantinides1970,jackson1996filters,antoniou2006filters}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.96\textwidth]{fig_transfer.pdf}
...
Circles: frozen coefficient catalogs.
Squares: frozen magnitude-response catalogs.
...
implementations.
A secondary invalid challenge was not balanced across all tasks;
...
Code and frozen artifacts are in the accompanying public repository.
